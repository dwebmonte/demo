...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'admin/b-user-info.tpl', 296, false),)), $this); ?>
<!-- start postfilter file="admin/b-user-info.tpl" -->
<!-- start prefilter file="admin/b-user-info.tpl" -->
<ul class="user-info-menu left-links list-inline list-unstyled">
	<li class="hidden-sm hidden-xs" style="min-height: 77px;"><a href="#" data-toggle="sidebar"><i class="fa-bars"></i></a></li>
