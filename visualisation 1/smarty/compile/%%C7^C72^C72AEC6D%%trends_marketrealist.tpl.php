<?php /* Smarty version 2.6.28, created on 2019-02-01 18:00:38
         compiled from Z:/home/aleney/www/aggnews.tickeron.com/visualisation+1/templates/trends_marketrealist.tpl */ ?>
<!-- start postfilter file="Z:/home/aleney/www/aggnews.tickeron.com/visualisation 1/templates/trends_marketrealist.tpl" -->
<!-- start prefilter file="Z:/home/aleney/www/aggnews.tickeron.com/visualisation 1/templates/trends_marketrealist.tpl" -->
<div class="row">
...
" class="collapsed">
					...
					<div class="label label-success label_category"><?php echo $this->_tpl_vars['item']['article']->categories; ?>
</div>
...
?>
					<h5> 
							...
							<i class="fa-comment popover-secondary copy_article" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="<?php echo $this->_tpl_vars['item']['article']->text_300w; ?>
" data-original-title="<?php echo $this->_tpl_vars['item']['article']->title; ?>
"></i>

							<?php if (is_null ( $this->_tpl_vars['item']['article']->user_id_at_work )): ?>
								<a href="#" data-article-id="<?php echo $this->_tpl_vars['item']['article']->id; ?>
" api-href="article/at_work" api-param='"article_id":"<?php echo $this->_tpl_vars['item']['article']->id; ?>
"' <?php echo ' api-handler=\'if (state == "action" && data.do == "state") { console.log(data.res); let $i = $(".in_work[data-article-id="+ data.article_id +"] > i"); if (!data.res) $i.removeClass("fa-bell").addClass("fa-bell-o"); else $i.removeClass("fa-bell-o").addClass("fa-bell"); }\' '; ?>
 class="in_work"><i class="fa-bell-o"></i></a>
							<?php elseif ($this->_tpl_vars['item']['article']->user_id_at_work == $_SESSION['user']['id']): ?>
								<a href="#" data-article-id="<?php echo $this->_tpl_vars['item']['article']->id; ?>
" api-href="article/at_work" api-param='"article_id":"<?php echo $this->_tpl_vars['item']['article']->id; ?>
"' <?php echo ' api-handler=\'if (state == "action" && data.do == "state") { console.log(data.res); let $i = $(".in_work[data-article-id="+ data.article_id +"] > i"); if (!data.res) $i.removeClass("fa-bell").addClass("fa-bell-o"); else $i.removeClass("fa-bell-o").addClass("fa-bell"); }\' '; ?>
 class="in_work"><i class="fa-bell"></i></a>
							<?php else: ?>
...
" target="_blank"><?php echo $this->_tpl_vars['item']['article']->title; ?>
							...
							<span class="label label-success label_category_litte"><?php echo $this->_tpl_vars['item']['article']->categories; ?>
</span>
...
<!-- end prefilter file="Z:/home/aleney/www/aggnews.tickeron.com/visualisation 1/templates/trends_marketrealist.tpl" -->
<!-- end postfilter file="Z:/home/aleney/www/aggnews.tickeron.com/visualisation 1/templates/trends_marketrealist.tpl" -->
