<?php /* Smarty version 2.6.28, created on 2018-11-22 08:04:43
         compiled from /var/www/html/visualisation+1/templates/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', '/var/www/html/visualisation 1/templates/index.tpl', 85, false),)), $this); ?>
<!-- start postfilter file="/var/www/html/visualisation 1/templates/index.tpl" -->
<!-- start prefilter file="/var/www/html/visualisation 1/templates/index.tpl" -->
<!DOCTYPE html>	
<html lang="en">
<head>
	<meta charset="utf-8">
...
/images/user-4.png" class="img-circle img-corona" alt="user-pic" width="60" height="60">
							<span><strong><?php echo ((is_array($_tmp=@$_SESSION['user']['name'])) ? $this->_run_mod_handler('default', true, $_tmp, 'Admin') : smarty_modifier_default($_tmp, 'Admin')); ?>
</strong>Admin</span>
						</a>
					</div>
				</section>
...
"><i class="fa-home"></i><span class="title">Dashboard</span></a></li>
...
<!-- end prefilter file="/var/www/html/visualisation 1/templates/index.tpl" -->
<!-- end postfilter file="/var/www/html/visualisation 1/templates/index.tpl" -->
