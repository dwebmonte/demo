...
function smarty_postfilter_content($source, &$smarty)  {
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~					onSmartyPostfilter
	$event_name = "onSmartyPostfilter";
	...
	if (DEVELOPE) {
		$source = "<!-- start postfilter file=\"{$smarty->_current_file}\" -->\r\n{$source}\r\n<!-- end postfilter file=\"{$smarty->_current_file}\" -->\r\n";
	};
