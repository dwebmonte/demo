				...
				<div class="conversation-window">
					...
					<ul class="conversation-messages ps-scrollbar ps-scroll-down">
						...
						<li>
							<div class="user-info">
								<a href="#">
									<img src="{$smarty.const.ASSETS_PATH}/images/user-1.png" width="30" height="30" alt="user-image" />
								</a>
							</div>
						...
						<li class="me"><!-- adding class="me" will indicate that "you" are sending a message -->
							...
							<div class="user-info">
								<a href="#">
									<img src="{$smarty.const.ASSETS_PATH}/images/user-4.png" width="30" height="30" alt="user-image" />
								</a>
							</div>
						</li>
