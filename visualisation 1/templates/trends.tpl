			...
			<div class="panel-body">
				{foreach from=$item_block item=item key=key name=news}
					<h5> 
							...
							<i class="fa-comment popover-secondary" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="{$item.article->text_300w}" data-original-title="{$item.article->title}"></i>
